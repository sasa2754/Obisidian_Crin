...
- [x] Entender como a Zeiss ta conectada no paperless na UP (Diferença entre zeiss e DEA)
- [x] Ver com a Kassia pq a Zeiss não ta funcionando ou não estão usando ela
- [x] Descobrir pq eles querem usar as duas
- [x] Descobrir qual exatamente é o problema em usar as duas máquinas juntas
